...
class TestEnvironmentBuilder(fake_filesystem_unittest.TestCase):
    ...
    def test_will_create_devenv_dir(self, mock_virtualenv, mock_subprocess):
    ...
    @mock.patch('virtualenv.create_environment')
    @mock.patch('subprocess.call')
    def test_will_create_project_dir(self, mock_virtualenv, mock_subprocess):
    ...
    @mock.patch('virtualenv.create_environment')
    @mock.patch('subprocess.call')
    def test_will_create_dependencies_dir(self, mock_virtualenv, mock_subprocess):
        EnvironmentBuilder.build('project', self._config)
    ...
    @mock.patch('subprocess.call')
    @mock.patch('virtualenv.create_environment')
    def test_will_create_virtualenv_in_devenv_dir(self, mock_virtualenv, mock_subprocess):
        EnvironmentBuilder.build('project', self._config)
    ...
    @mock.patch('subprocess.call')
    @mock.patch('virtualenv.create_environment')
    def test_will_create_downloads_dir(self, mock_virtualenv, mock_subprocess):
        EnvironmentBuilder.build('project', self._config)
